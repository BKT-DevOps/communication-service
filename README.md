...
[![GitHub](https://img.shields.io/badge/GitHub-BKT-DevOps-181717?style=flat-square&logo=github)](https://github.com/BKT-DevOps/communication-service)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](LICENSE)

**Part of [Kovan Project](docs/Project-Definition.md)**
...
> **ÖNEMLİ:** Bu repository **Kovan Project** projesinin bir parçasıdır. Proje hakkında detaylı bilgi için [`docs/Project-Definition.md`](docs/Project-Definition.md) dosyasına bakın.
...
> **IMPORTANT:** This repository is part of **Kovan Project** project. See [`docs/Project-Definition.md`](docs/Project-Definition.md) for details.
