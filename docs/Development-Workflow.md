...
Bu belge, Kovan Project projesindeki geliştirme süreçleri, standartları ve iş akışları için bir rehberdir.
...
This document is a guide for development processes, standards, and workflows in the Kovan Project project.
